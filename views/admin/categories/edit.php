<div class="one_half" id="">
  ...
  <section class="title">
  	<?php if (isset($id) AND $id > 0): ?>
  		<h4><?php echo sprintf(lang('shop_categories:form:title:edit'), $name); ?></h4>
  	<?php else: ?>
  		<h4><?php echo lang('shop_categories:form:title:new'); ?></h4>
  	<?php endif; ?>
  </section>
...
<section class="item form_inputs">
	<div class="content">
		...
		<fieldset>
			<ul>
				<li>
					<a class='btn green' href="admin/shop_categories/categories/">Back to List</a>
					<?php if (isset($id) AND $id > 0): ?>
					<?php if($parent_id>0) :?>
						...
						<?php if($parent_cat->parent_id >0):?>
								...
								<?php if($parent_cat2->parent_id >0):?>
										...
										<?php if($parent_cat3->parent_id >0):?>
											<a class='btn gray' href="admin/shop_categories/categories/edit/<?php echo $parent_cat3->parent_id;?>">...</a>
										<?php endif; ?>
									...
									<a class='btn gray' href="admin/shop_categories/categories/edit/<?php echo $parent_cat2->parent_id;?>"><?php echo HelperGet_category_name($parent_cat2->parent_id);?></a>
								<?php endif; ?>


							<a class='btn gray' href="admin/shop_categories/categories/edit/<?php echo $parent_cat->parent_id;?>"><?php echo HelperGet_category_name($parent_cat->parent_id);?></a>
						<?php endif; ?>
						<a class='btn gray' href="admin/shop_categories/categories/edit/<?php echo $parent_id;?>"><?php echo HelperGet_category_name($parent_id);?></a>
					<?php endif;?>

					<a class='btn orange' href="admin/shop_categories/categories/edit/<?php echo $id;?>"><?php echo $name;?></a>
					<?php endif;?>

				</li>
				<li class="<?php echo alternator('even', ''); ?>">
					<label for="name"><?php echo lang('shop_categories:name');?><span>*</span></label>
					<div class="input">
						<?php echo form_input('name', set_value('name', $name), 'id="name" '); ?>
					</div>
				</li>
				<li class="<?php echo alternator('', 'even'); ?>">
					<label for="slug"><?php echo lang('shop_categories:slug');?><span>*</span></label>
        ...
        <li class="">
          ...
          Current Status is:
                <?php if($hidden):?>
                    <a title='Click to Toggle' href='admin/shop_categories/categories/visibility/<?php echo $id;?>/off' class='tooltip-s button delete_button'>Hidden</a>
                <?php else: ?>
                    <a title='Click to Toggle' href='admin/shop_categories/categories/visibility/<?php echo $id;?>/on' class='tooltip-s button edit_button'>Visible</a>
                <?php endif;?>
				...
				<li>
					<label><?php echo lang('shop_categories:image');?></label>
					<div id='' name=''>
				...
				<li>
					<label for="user_data"><?php echo lang('shop_categories:description');?><span></span></label>
					<div class="input">
		...
		<div class="buttons">
				<button class="btn blue" value="save_exit" name="btnAction" type="submit">
					<span><?php echo lang('shop_categories:save_exit');?></span>
				</button>

				<?php $this->load->view('admin/partials/buttons', array('buttons' => array('save'))); ?>

				<a href="admin/shop_categories/categories/" class="btn gray">Cancel</a>
		</div>
...
<section class="title" >
  ...
  <span style="float:right;margin-right:10px;">
    <a id="" href="shop_categories/admin/categories/addchild/<?php echo $id;?>" class='modal tooltip-s small button blue'><?php echo lang('shop_categories:create');?> Subcategory</a>
  </span>
</section>
	...
	<div class="content">
		<table class='sortable' id='sortable_list'>
			<thead>
				<tr>
					<th></th>
					<th><?php echo lang('shop_categories:id');?></th>
					<th><?php echo lang('shop_categories:category');?></th>
					<th>Image</th>
          <th></th>
				</tr>
			</thead>
			<tbody>
				<?php
					...
					{
						$editlink 	= "<a class='btn orange' href='admin/shop_categories/categories/edit/"  .$child->id ."'>edit</a> ";
						$dellink  	= "<a class='btn red delete confirm' href='admin/shop_categories/categories/delete/"  .$child->id . "/".$id."'>delete</a>";
      ...
      $(function() {
        ...
        */
        $(document).on('click', '.delCategoryImage', function(event) {  //this works much better
              ...
              {
                  var url = "<?php echo site_url();?>admin/shop_categories/images/remove/{{id}}/" + options.attr("file-id");
        ...
        // event listeners
        var myDropzone = new Dropzone("div#mydrop", { url: "<?php echo site_url();?>admin/shop_categories/images/upload/<?php echo $id;?>"});
