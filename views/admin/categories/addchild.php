	<div style="">
	<?php echo form_open_multipart('admin/shop_categories/categories/savechild/', 'id="myform" class="crud"'); ?>
	<?php echo form_hidden('id', $id ); ?>
				...
				<?php echo form_hidden('start_order_from', 0); ?>
	 			...
	 			<section>
					<ul id="" >
							<li>
								<label>Child <?php echo lang('shop:categories:category_name');?></label>
								<div class="">
				...
				<div style='clear:both'>
					<section>
						<div class="buttons">
							...
							<a class="btn gray cancel" href="admin/shop_categories">Cancel</a>
						</div>
					</section>
				</div>
