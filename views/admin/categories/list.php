<?php echo form_open('admin/shop_categories/categories/delete'); ?>
<div class="one_full" id="">
		<section class="title">
				<h4><?php echo lang('shop_categories:title');?></h4>
		</section>
		<section class="item">
			<div class="content">
		<?php if (empty($categories)): ?>
				<div class="no_data">
					<br />
					<p>
						<?php echo lang('shop_categories:categories');?>
					</p>

					<?php echo lang('shop_categories:no_categories'); ?>
					<br /><br /><br />
					<p>
		...
		<table class='sortable' id='sortable_list'>
			<thead>
				<tr>
					...
					<th><?php echo lang('shop_categories:image');?></th>
					...
					<tr>
						...
						<td>
							<span style="float:right;">
								<?php echo dropdownMenu('admin/shop_categories/categories', $category->id,  TRUE,TRUE,FALSE);?>
							</span>
						</td>
					</tr>
