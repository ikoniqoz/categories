...
class Categories extends Admin_Controller
{
	...
	public function create($redirect='standard')
	{
		...
		if ($this->form_validation->run())
		{
			...
			//Redirect
			redirect('admin/shop_categories/categories/edit/'.$id);
	...
	public function edit( $id = null)
	{
		...
		if( ! $id || ! is_numeric($id) )
		{
			$this->session->set_flashdata('error', lang('shop_categories:invalid_id') );
			redirect('admin/shop_categories/categories');
		}
	...
	public function savechild()
	{
		...
		if( $input = $this->input->post() )
		{
			...
			if(isset($input['btnAction']))
			{
				...
				{
					redirect('admin/shop_categories/categories/edit/'.$new_id);
				}
			}
	...
	public function visibility($category_id, $show='on')
	{
		...
		redirect('admin/shop_categories/categories/edit/'.$category_id);
	}
